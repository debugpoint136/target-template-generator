    ...
    const renderComponents = () => {
      let { activeIndex } = this.state
        switch(activeIndex) {
          ...
          case '4':
              return <TableEditable data={this.state.filesInfo} onSubmit={this.processSubmissionStep4} handleResetClick={this.handleResetExperimentDesign} update={this.props.match.params.id}/>
          case '5':
